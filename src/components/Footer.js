  ...
  return (
    <footer className="site-footer" role="contentinfo">
      <div className="content">
        ...
        <p className="footer-line">Source code of this site is available at <a href="https://github.com/tingxi-li/portfolio" rel="noopener noreferrer" target="_blank">GitHub</a>.</p>
      </div>
    </footer>
  );
}
